     ...
     <div class="container-xxl bg-white p-0">
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <a href="home-user-payment.php" class="nav-item nav-link">Payment</a>
                </div>
                        ...
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-10 col-lg-8">
                                    ...
                                    <p class="fs-5 fw-medium text-white mb-4 pb-2">Welcome back User! Park you car using our system! </p>
                                    <a href="#park" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Park my Car!</a>
                                    <form action="emergency.php" <?php echo $_SESSION['username'];?> method="POST">
        ...
        <div class="container-xxl py-5">
            <div class="container">
                ...
                <?php
                    include_once('db.php');
                    $query="SELECT * FROM parking_rates WHERE category='user'";
                ...
                <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Park your Car in our Normal Parking!</h1>
                    ...
                    <table id="customers">
                        ...
                        <tr>
                            ...
                            <td><?php $current_time = date('H:i:s'); echo "$current_time";?></td>
                            <td>
        ...
        <div id="park" class="container-xxl py-5">
            <div class="container">
                <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Park your Car in our Normal Parking!</h1>
